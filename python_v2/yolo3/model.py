...
ROOT_PATH = os.path.join(os.path.dirname(os.path.realpath(__file__)), '../../model')
...
yolo3_tiny_model_map = {
    ...
    'tiny_yolo3_darknet': [custom_tiny_yolo3_body, 20, os.path.join(ROOT_PATH, 'yolo3_tiny', 'yolov3-tiny.h5')],
    #Doesn't have pretrained weights, so no need to return backbone length
